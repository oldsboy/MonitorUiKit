 ...
 * @Version: 1.0
 */
public class Dialog_ShowMapPicture extends com.oldsboy.monitoruikit.tableview.dialog.BaseMapDialog {
    private String img_path;

    private ImageView imgContent;

    public Dialog_ShowMapPicture(@NonNull Context context, String img_path) {
        super(context);
