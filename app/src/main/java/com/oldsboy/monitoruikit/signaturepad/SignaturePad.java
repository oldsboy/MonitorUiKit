package com.oldsboy.monitoruikit.signaturepad;
...
public class SignaturePad extends View
{
    ...
    public SignaturePad(Context context, AttributeSet attrs)
    {
        ...
        //Configurable parameters
        try {
            mMinWidth = a.getFloat(R.styleable.SignaturePad_minWidth, 8f);
            mMaxWidth = a.getFloat(R.styleable.SignaturePad_maxWidth, 12f);
            mVelocityFilterWeight = a.getFloat(R.styleable.SignaturePad_velocityFilterWeight, 0f);
